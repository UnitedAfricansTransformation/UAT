...
Public Class MembershipReport
    ...
    Dim Query As String
    Dim userTitle, Province, District As String
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                If userTitle = "National" Then
                    Query = "Select MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM tblMembership order by Province,DistrictMunicipality,LocalMunicipality, LastName "
                    Me.LoadGridFilter(Query)
                    btnRegister.Visible = True

                ElseIf userTitle = "Provincial" Then
                    Query = "Select MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM tblMembership where Province = '" & Province & "' order by DistrictMunicipality,LocalMunicipality,LastName "
                    Me.LoadGridFilter(Query)
                ElseIf userTitle = "District" Then
                    Query = "Select MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM tblMembership where DistrictMunicipality = '" & District & "' order by LocalMunicipality,LastName "
                    Me.LoadGridFilter(Query)
                End If
            End If
        End If
    ...
    Protected Sub drdSearchCriteria_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drdSearchCriteria.SelectedIndexChanged
        ...
        ElseIf drdSearchCriteria.SelectedItem.Text = "Membership Number" Then
            ...
            ddlgender.Visible = False
        ElseIf drdSearchCriteria.SelectedValue = "Structure" Then
            lblSearch.Text = "Select Structure/League"
            ddlStructure.Visible = True
            txtIDNumber.Visible = False
            txtMembership.Visible = False
            ddlgender.Visible = False
        ElseIf drdSearchCriteria.SelectedValue = "Gender" Then
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If drdSearchCriteria.SelectedItem.Text = "ID Number" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [tblMembership] where IDNumber = '" + txtIDNumber.Text + "' order by LastName "
            Me.LoadGridFilter(Query)
        ElseIf drdSearchCriteria.SelectedItem.Text = "Membership Number" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [tblMembership] where MembershipNo = '" + txtMembership.Text + "' order by LastName "
            Me.LoadGridFilter(Query)
        ElseIf drdSearchCriteria.SelectedItem.Text = "Structure" And ddlStructure.SelectedItem.Text <> "pdf" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [tblMembership] where UATStructure = '" + ddlStructure.SelectedItem.Text + "' order by LastName "
            Me.LoadGridFilter(Query)
        ...
        ElseIf drdSearchCriteria.SelectedItem.Text = "Structure" AndAlso ddlStructure.SelectedItem.Text = "pdf" AndAlso userTitle <> "National" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [tblMembership] where Disability = 'Yes' and DistrictMunicipality = '" + District + "' order by LocalMunicipality,LastName"
            Me.LoadGridFilter(Query)
        ElseIf drdSearchCriteria.SelectedItem.Text = "Gender" AndAlso userTitle <> "National" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [[tblMembership] where Gender = '" + ddlgender.SelectedItem.Text + "' and DistrictMunicipality = '" + District + "' order by LocalMunicipality,LastName"
            Me.LoadGridFilter(Query)


        ElseIf drdSearchCriteria.SelectedItem.Text = "Structure" AndAlso ddlStructure.SelectedItem.Text = "pdf" AndAlso userTitle = "National" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [tblMembership] where Disability = 'Yes' order by DistrictMunicipality,LocalMunicipality,LastName"
            Me.LoadGridFilter(Query)
        ElseIf drdSearchCriteria.SelectedItem.Text = "Gender" AndAlso userTitle = "National" Then
            Query = "SELECT MembershipNo, expirydate, FirstName, LastName, IDNumber, PreferredLanguage, RegisteredVoter, CellNumber,Province,DistrictMunicipality,LocalMunicipality,WardNo,LocationName FROM [[tblMembership] where Gender = '" + ddlgender.SelectedItem.Text + "' order by DistrictMunicipality,LocalMunicipality,LastName"
            Me.LoadGridFilter(Query)
        End If
